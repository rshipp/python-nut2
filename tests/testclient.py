...
class TestClient(unittest.TestCase):
    ...
    def test_get_ups_list_broken(self):
        self.assertRaises(Exception, self.broken_client.list_ups)
    ...
    def test_get_ups_vars_invalid_ups(self):
        self.assertRaises(Exception, self.client.list_vars, self.invalid)

    def test_get_ups_vars_broken(self):
        self.assertRaises(Exception, self.broken_client.list_vars, self.valid)
    ...
    def test_get_ups_commands_invalid_ups(self):
        self.assertRaises(Exception, self.client.list_commands, self.invalid)

    def test_get_ups_commands_broken(self):
        self.assertRaises(Exception, self.broken_client.list_commands,
                self.valid)
    ...
    def test_get_rw_vars_invalid_ups(self):
        self.assertRaises(Exception, self.client.list_rw_vars, self.invalid)
    ...
    def test_set_rw_var_invalid(self):
        self.assertRaises(Exception, self.client.set_var, self.invalid,
                self.invalid, self.invalid)

    def test_set_rw_var_broken(self):
        self.assertRaises(Exception, self.broken_client.set_var, self.valid,
    ...
    def test_run_ups_command_invalid(self):
        self.assertRaises(Exception, self.client.run_command, self.invalid,
                    self.invalid)

    def test_run_ups_command_broken(self):
        self.assertRaises(Exception, self.broken_client.run_command, self.valid,
                    self.valid)
    ...
    def test_list_clients_invalid(self):
        self.assertRaises(Exception, self.client.list_clients,
                self.invalid)
    ...
    def test_list_clients_broken(self):
        self.assertRaises(Exception, self.broken_client.list_clients,
                self.valid)
